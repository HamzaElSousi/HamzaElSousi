...
<!--
## Hi there 👋
**HamzaElSousi/HamzaElSousi** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
<p align="center">
  <a href="https://www.linkedin.com/in/hamza-el-sousi">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" />
  </a>
  <a href="https://hamzaelsousi.com">
    <img src="https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=About.me&logoColor=white" />
  </a>
  <a href="mailto:hamza.sousi1998@gmail.com">
...
<img src="https://img.shields.io/badge/Sentry-E6522C?style=for-the-badge&logo=prometheus&logoColor=white" />
...
| **[🛠️ AgentForge](https://github.com/HamzaElSousi/agentforge)** | **Multi-agent framework where the whole pipeline is a YAML file** — agents run a hand-written ReAct loop (native tool-calling + text fallback), hand off, and emit a full `trace.json`. Bring your own model (OpenRouter / Anthropic / OpenAI / local Ollama). First-class **hard cost caps**, a tiered sandbox (SSRF + workspace jail), and human-in-the-loop approvals that **never hang in CI**. Live-verified end-to-end. | `Python` `Pydantic` `Typer` `httpx` `tiktoken` `OpenRouter` `Ollama` |

> 🔨 **Shipping next:** LLM eval & red-teaming harness · real-time voice agent · LoRA fine-tuning toolkit.
...
<div align="center">
  <img src="https://komarev.com/ghpvc/?username=HamzaElSousi&color=blueviolet&style=flat-square&label=Profile+Views" alt="Profile Views" />
  <br />
  <sub>Designed & Architected by <a href="https://github.com/HamzaElSousi">Hamza El Sousi</a></sub>
</div>
